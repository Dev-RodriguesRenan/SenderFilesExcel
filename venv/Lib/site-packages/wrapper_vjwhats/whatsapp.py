...
class WhatsApp:
    ...
    def get_images_sent(self, ultima_imagem: int = 1):
        ...
        try:
            ...
            dadosButton.click()
            LOGGER.info('Data profile button clicked, waiting for "Mídia, links e docs" button...')
            ...
            dadosButton.click()
            LOGGER.info('"Mídia, links e docs" button clicked, waiting for media list to load...')
            ...
            while True:
                ...
                LOGGER.info('First image in the list clicked, checking for "Anterior" button...')
